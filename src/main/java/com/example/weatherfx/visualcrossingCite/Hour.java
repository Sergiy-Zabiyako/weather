...
public class Hour {
    ...
    public Hour(String datetime, int datetimeEpoch, double temp, double feelslike, double humidity, double dew, double precip, double precipprob, double snow, double snowdepth, Object preciptype, double windgust, double windspeed, double winddir, double pressure, double visibility, double cloudcover, double solarradiation, double solarenergy, double uvindex, double severerisk, String conditions, String icon, ArrayList<String> stations, String source) {
